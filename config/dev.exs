...
config :multimeter, MultimeterWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "RHjlIz+mIXGlru3Wi7bHJx9c1do8m9vw2NW7sOLtbeHjWgQ9K1zHDaXtkO2R42FE",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:multimeter, ~w(--sourcemap=inline --watch)]}
  ]
...
config :multimeter, MultimeterWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/multimeter_web/(controllers|live|components)/.*(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :multimeter, dev_routes: true
